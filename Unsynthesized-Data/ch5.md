Here is your vocabulary organized into the six sections you identified.

---

# 1. Merchandising Operations

These terms describe the overall activities and profitability of merchandising businesses.
...
# 2. Recording Purchases and Sales in Perpetual Systems

These terms involve recording inventory transactions continuously.
...
# 3. Preparing Multi-Step Income Statements

These terms relate directly to financial statement presentation and profitability reporting.
...
These terms govern ownership and inventory classification rules.
...
# 5. Profit Margins and Profitability Analysis

These terms focus on evaluating company performance.
...
During the year ended December 31, 2025, Bjornstad Corporation had the following results: net sales $267,000, cost of goods sold $107,000, net income $92,400, operating expenses $55,400, and net cash provided by operating activities $108,950. What was the company’s profit margin?
...
is computed as net income divided by net cash provided by operating activities.
that is less than 1 indicates that a company might be using aggressive accounting tactics.
that is greater than 1 indicates that a company might be using aggressive accounting tactics.
is computed as net cash provided by operating activities divided by total assets.
